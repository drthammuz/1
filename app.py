...
def delete_expense(transaction_id):
    ...
    expense = Transaction.query.get_or_404(transaction_id)  # Add this line to fetch the expense object from the database
...
def delete_sale(transaction_id):
    ...
    sale = Transaction.query.get_or_404(transaction_id)  # Add this line to fetch the sale object from the database
